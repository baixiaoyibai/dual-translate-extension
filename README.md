...
> **版本变更历史请见 [CHANGELOG.md](./CHANGELOG.md)**，当前版本：**v1.0.8**
...
**API 管理**　启用 / 关闭接口、修改密钥、拖拽调整使用顺序、「测试」按钮验证连通，各接口旁标注免费额度

**额度限制**　为每个接口设置月度使用上限（字符或 Token），达到 97% 自动切换到下一翻译源

**温馨提示**　免责声明、插件工作原理、翻译效果示例、额度限制说明、术语库使用说明、密钥存储说明
